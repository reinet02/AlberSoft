    ...
    public partial class fmJuegoDeParesCocina : Form
    {
            ...
            if (cartasSeleccionadas.Count == 2)
            {
                ...
                if (n1 == n2)
                {
                    ...
                    if (parejasEncontradas >= 8)
                    {
                        ...
                        MessageBox.Show("En una cocina comunitaria, cada par que encontraste representa una mano que ayuda y un plato que alimenta. Lograste unir todas las piezas, demostrando que cuando trabajamos juntos, nadie se queda atrás. ¡Gracias por compartir tu talento hoy! 🥖🤝", "¡La mesa está servida y el corazón lleno! ❤️", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
                else
                {
        ...
        private void GameTimer_Tick(object? sender, EventArgs e)
        {
            ...
            if (tiempoRestante <= 0)
            {
                ...
                MessageBox.Show("El reloj nos ganó esta vuelta, pero en la cocina comunitaria siempre hay fuego encendido para un segundo intento. No te preocupes, el ingrediente secreto es la perseverancia. ¡Atrévete a cocinar una nueva partida, te esperamos con el delantal puesto! 🥣", "¡Casi terminamos la receta! 👩‍🍳", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnsolucionintermedio_Click_1(object sender, EventArgs e)
        {
