namespace AlberSoft.menuPrincipal
{
    partial class fmRegistro
    {
        ...
        private void InitializeComponent()
        {
            ...
            enlaceInicarSesion.LinkClicked += linkIniciarSesion_LinkClicked;
            // 
            // lbTitulo
            // 
            ...
            tablaBtn.Controls.Add(btnCrearCuenta, 0, 0);
            ...
            btnCrearCuenta.HoverBackground = Color.FromArgb(200, 180, 190, 254);
            btnCrearCuenta.HoverForeColor = Color.White;
            ...
            btnCrearCuenta.Location = new Point(3, 3);
            ...
            btnCrearCuenta.Size = new Size(435, 51);
            ...
            tbUsuario.PlaceholderColor = Color.FromArgb(166, 173, 200);
            tbUsuario.PlaceholderText = "Ejemplo: Tony23 o noelia#:3";
            ...
            tbContrasena.PlaceholderText = "Ejemplo: GatoNegro123 o naruto123";
