namespace AlberSoft.actividadesRecreativas.Cocina_Comunitaria
{
    partial class fmplanta1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.TabIndex = 4;
            label2.Text = "Riego: 1 vez por semana (esperar a que seque).";
            ...
            label1.TabIndex = 3;
            label1.Text = "Luz: Semisombra / Sol indirecto.";
            ...
            label7.TabIndex = 5;
            label7.Text = "Corta las hojas más grandes según las necesites; esto estimula el crecimiento.";
            ...
            label5.TabIndex = 5;
            label5.Text = "Es un excelente repelente natural de insectos para proteger otras plantas del huerto.";
            ...
            label8.TabIndex = 0;
            label8.Text = "Mantener alejado de mascotas.";
            ...
            tblnombre2.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            tblnombre2.Controls.Add(label10, 0, 1);
            ...
            tblnombre2.RowCount = 2;
            tblnombre2.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            tblnombre2.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            ...
            label10.Font = new Font("Microsoft Sans Serif", 48F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label10.ForeColor = Color.DarkSeaGreen;
            label10.Location = new Point(3, 85);
            label10.Name = "label10";
            label10.Size = new Size(543, 85);
            label10.TabIndex = 1;
            label10.Text = "OREJÒN";
            ...
            label11.TabIndex = 1;
            label11.Text = "\"Coleus amboinicus\"";
            // 
            // pictureBox5
            // 
            pictureBox5.Dock = DockStyle.Fill;
            pictureBox5.Image = Properties.Resources.oregano;
            ...
            tblbibliografia.Controls.Add(pictureBox7, 0, 0);
            tblbibliografia.Dock = DockStyle.Fill;
            tblbibliografia.Location = new Point(3, 864);
            ...
            tblbibliografia.Size = new Size(555, 82);
            tblbibliografia.TabIndex = 5;
            // 
            // tblregresar
            // 
            tblregresar.ColumnCount = 2;
            tblregresar.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 77F));
            tblregresar.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 23F));
            tblregresar.Controls.Add(pictureBox6, 1, 0);
            tblregresar.Dock = DockStyle.Fill;
            tblregresar.Location = new Point(564, 864);
            ...
            tblregresar.Size = new Size(556, 82);
            tblregresar.TabIndex = 6;
            // 
            // pictureBox6
            // 
