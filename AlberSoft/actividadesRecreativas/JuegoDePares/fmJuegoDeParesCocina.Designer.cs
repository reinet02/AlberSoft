namespace AlberSoft.activadesRecreativas
{
    partial class fmJuegoDeParesCocina
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnsolucionintermedio = new CuoreUI.Controls.cuiButton();
            ...
            btnReinicio.ForeColor = Color.FromArgb(203, 166, 247);
            btnReinicio.HoverBackground = Color.Thistle;
            btnReinicio.HoverForeColor = Color.FromArgb(203, 166, 247);
            ...
            btnReinicio.PressedForeColor = Color.FromArgb(203, 166, 247);
            ...
            btnReinicio.Size = new Size(322, 82);
            ...
            // tableroGeneral
            // 
            tableroGeneral.BackColor = Color.FromArgb(203, 166, 247);
            ...
            tablero2.Controls.Add(btnsolucionintermedio, 0, 4);
            tablero2.Dock = DockStyle.Fill;
            tablero2.Location = new Point(782, 4);
            tablero2.Margin = new Padding(3, 4, 3, 4);
            tablero2.Name = "tablero2";
            tablero2.RowCount = 5;
            tablero2.RowStyles.Add(new RowStyle(SizeType.Percent, 21.5315F));
            tablero2.RowStyles.Add(new RowStyle(SizeType.Percent, 15.7948637F));
            tablero2.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0502825F));
            tablero2.RowStyles.Add(new RowStyle(SizeType.Percent, 40.9301949F));
            tablero2.RowStyles.Add(new RowStyle(SizeType.Percent, 10.6931629F));
            ...
            tableLayoutPanel1.Location = new Point(3, 396);
            ...
            pictureBox1.Size = new Size(316, 321);
            pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox1.TabIndex = 0;
            pictureBox1.TabStop = false;
            // 
            // btnsolucionintermedio
            // 
            btnsolucionintermedio.CheckButton = false;
            btnsolucionintermedio.Checked = false;
            btnsolucionintermedio.CheckedBackground = Color.FromArgb(255, 106, 0);
            btnsolucionintermedio.CheckedForeColor = Color.White;
            btnsolucionintermedio.CheckedImageTint = Color.White;
            btnsolucionintermedio.CheckedOutline = Color.FromArgb(255, 106, 0);
            btnsolucionintermedio.Content = "✍ Solución";
            btnsolucionintermedio.DialogResult = DialogResult.None;
            btnsolucionintermedio.Dock = DockStyle.Fill;
            btnsolucionintermedio.Font = new Font("Microsoft Sans Serif", 19.8000011F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnsolucionintermedio.ForeColor = Color.FromArgb(203, 166, 247);
            btnsolucionintermedio.HoverBackground = Color.Thistle;
            btnsolucionintermedio.HoverForeColor = Color.FromArgb(203, 166, 247);
            btnsolucionintermedio.HoverImageTint = Color.White;
            btnsolucionintermedio.HoverOutline = Color.FromArgb(32, 128, 128, 128);
            btnsolucionintermedio.Image = null;
            btnsolucionintermedio.ImageAutoCenter = true;
            btnsolucionintermedio.ImageExpand = new Point(0, 0);
            btnsolucionintermedio.ImageOffset = new Point(0, 0);
            btnsolucionintermedio.Location = new Point(3, 729);
            btnsolucionintermedio.Name = "btnsolucionintermedio";
            btnsolucionintermedio.NormalBackground = Color.White;
            btnsolucionintermedio.NormalForeColor = Color.FromArgb(203, 166, 247);
            btnsolucionintermedio.NormalImageTint = Color.White;
            btnsolucionintermedio.NormalOutline = Color.FromArgb(64, 128, 128, 128);
            btnsolucionintermedio.OutlineThickness = 1F;
            btnsolucionintermedio.PressedBackground = Color.WhiteSmoke;
            btnsolucionintermedio.PressedForeColor = Color.FromArgb(32, 32, 32);
            btnsolucionintermedio.PressedImageTint = Color.White;
            btnsolucionintermedio.PressedOutline = Color.FromArgb(64, 128, 128, 128);
            btnsolucionintermedio.Rounding = new Padding(8);
            btnsolucionintermedio.Size = new Size(322, 83);
            btnsolucionintermedio.TabIndex = 6;
            btnsolucionintermedio.TextAlignment = StringAlignment.Center;
            btnsolucionintermedio.TextOffset = new Point(0, 0);
            btnsolucionintermedio.Click += btnsolucionintermedio_Click_1;
            // 
        ...
        private CuoreUI.Controls.cuiButton btnsolucionintermedio;
    }
}