...
{
    public partial class fmJuegoDeParesHuerto : Form
    {
        #region Declaramos variables
        // Límite de tiempo en segundos
        private const int TimeLimitSeconds = 15;
        ...
        private void timer_Cartas(object sender, EventArgs e)
        {
            ...
            if (cartaTemp1 != null)
                cartaTemp1.Image = Properties.Resources.parteTraseraDeCartasHuerto;
            if (cartaTemp2 != null)
                cartaTemp2.Image = Properties.Resources.parteTraseraDeCartasHuerto;
        ...
        private void carta_Click(object? sender, EventArgs e)
        {
            ...
            if (cartasSeleccionadas.Count == 2)
            {
                ...
                if (n1 == n2)
                {
                    ...
                    // Si se encuentran todas las parejas, avisar al usuario y detener temporizadores
                    if (parejasEncontradas >= 8)
                    {
                        ...
                        MessageBox.Show("¡Felicitaciones, al igual que en un huerto comunitario, cada semilla que plantaste en tu memoria dio frutos hoy. Encontraste todos los pares, recordándonos que con cuidado y dedicación, nuestra tierra y nuestra comunidad siempre florecen juntas!. ¡Gracias por cultivar un mundo mejor! ✨🥕", "¡Cosecha completada con éxito! 🧺🌿", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
                else
                {
        ...
        private void btnReinicio_Click(object? sender, EventArgs e)
        {
            ...
            foreach (Control c in tablero1.Controls)
            {
                ...
                {
                    pb.Image = Properties.Resources.parteTraseraDeCartasHuerto;
                    pb.Enabled = true;
                }
            }
        ...
        private void GameTimer_Tick(object? sender, EventArgs e)
        {
            ...
            if (tiempoRestante <= 0)
            {
                ...
                MessageBox.Show("El sol se ocultó antes de terminar la cosecha, pero no te desanimes. En el huerto, cada intento es abono para el éxito de mañana. ¡Regamos tus ganas de jugar y te esperamos para una nueva siembra! ¿Te animas a intentarlo otra vez? 🧤🌱", "¡La naturaleza tiene su propio ritmo! 🌦️", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private Bitmap RecuperarImagen(int numeroImagen)
        {
            ...
            {
                case 0:
                    return Properties.Resources.cartaRabano;
                case 1:
                    return Properties.Resources.cartaHierbabuena;
                case 2:
                    return Properties.Resources.cartaAlbahaca;
                case 3:
                    return Properties.Resources.cartaLechuga;
                case 4:
                    return Properties.Resources.cartaMaracuya;
                case 5:
                    return Properties.Resources.cartaOregano;
                case 6:
                    return Properties.Resources.cartaPapaya;
                case 7:
                    return Properties.Resources.cartaZanahoria;
                default:
                    return Properties.Resources.parteTraseraDeCartasHuerto;
            }
        }
        #endregion


        private void tnsoluciondificil_Click(object sender, EventArgs e)
        {
            // Sólo permitir mostrar la solución si el tiempo ha expirado
            if (tiempoRestante > 0)
            {
                MessageBox.Show("La solución sólo está disponible cuando se termina el tiempo,¡NO TE RINDAS!", "Información (>‿◠)✌", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
