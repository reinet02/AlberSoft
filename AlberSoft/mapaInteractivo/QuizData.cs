...
{
    // Clase simple que contiene preguntas para cada nivel
    public static class QuizData
    {
        ...
        // Devuelve 10 preguntas para el nivel pedido (1,2,3)
        public static List<Question> GetQuestionsForLevel(int level)
        {
            var list = new List<Question>();

            // Aquí se añaden preguntas de ejemplo. El profesor/alumno puede editarlas.
            if (level == 1)
            {
